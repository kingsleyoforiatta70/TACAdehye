                            ...
                            albumPhotos.map(photo => (
                                <div key={photo.id} className="relative group aspect-w-1 aspect-h-1 bg-gray-100 rounded-lg overflow-hidden">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-2 right-2 bg-red-600 text-white p-2 rounded-full opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity shadow-md"
                                        title="Delete Photo"
                                    >
                            ...
                            <div className="h-40 bg-gray-200 flex items-center justify-center relative">
                                ...
                                <div className="absolute top-2 right-2 flex space-x-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                                    <button
                                        ...
                                        className="bg-yellow-500 text-white p-2 rounded-full hover:bg-yellow-600 z-10 shadow-sm"
                                        title="Edit Album"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="bg-red-600 text-white p-2 rounded-full hover:bg-red-700 z-10 shadow-sm"
                                        title="Delete Album"
                                    >
